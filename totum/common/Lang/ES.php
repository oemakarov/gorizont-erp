...
class ES implements LangInterface
{
  ...
  'TOTUM-code format error [[%s]].' => 'Error de formato del código Gorizont-ERP [[%s]].',
  ...
  'TOTUM-code format error: missing operator in expression [[%s]].' => 'Error de formato de código Gorizont-ERP: falta operador en la expresión [[%s]].',
  'TOTUM-code format error: missing part of parameter.' => 'Error de formato de código Gorizont-ERP: falta parte del parámetro.',
