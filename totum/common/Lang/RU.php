...
class RU implements LangInterface
{
  ...
  'For temporary tables forms only.' => 'Только для форм на основе временных таблиц.',
  ...
  'The value of the number field should not be an array.' => 'Значение поля с типом Число не должно быть массивом.',
  ...
  'Not for the temporary table.' => 'Не предназначено для временной таблицы.',
  ...
  'For lists comparisons, only available =, ==, !=, !==.' => 'Для сравнения списков доступны только =, ==, !=, !==.',
  ...
  'TOTUM-code format error [[%s]].' => 'Ошибка формата GORIZONT-ERP-кода [[%s]].',
  ...
  'Error: %s' => 'Ошибка %s',
  'You cannot use linktoDataTable outside of actionCode without hide:true.' => 'Нельзя использовать linktoDataTable вне кода действия без hide:true.',
  'left element' => 'левый элемент',
  'right element' => 'правый элемент',
  'Division by zero.' => 'Деление на ноль.',
  'Unknown operator [[%s]].' => 'Неизвестный оператор [[%s]].',
  'Non-numeric parameter in the list %s' => 'Нечисловой параметр в списке %s',
  ...
  'TOTUM-code format error: missing operator in expression [[%s]].' => 'Ошибка формата GORIZONT-ERP-кода: отсутствие оператора в выражении [[%s]].',
  'TOTUM-code format error: missing part of parameter.' => 'Ошибка формата GORIZONT-ERP-кода: отсутствие части параметра.',
  'No key %s was found in the data row.' => 'Ключа %s в строке данных не обнаружено',
  'There is no [[%s]] key in the [[%s]] list.' => 'Не существует ключа [[%s]] в листе [[%s]].',
  'Regular expression error: [[%s]]' => 'Ошибка регулярного выражения: [[%s]]',
  'Parameter [[%s]] returned a non-true/false value.' => 'Параметр [[%s]] вернул значение отличное от true/false.',
  ...
  'Cannot access the current value of the field from the Code.' => 'Нельзя из кода типа Код (расчет значения в поле) обращаться к текущему значению поля.',
  ...
  'The value by %s key is not a row/list' => 'Значение по ключу %s — не является row или list',
  'The key must be an one value' => 'Ключ должен быть одинарным значением',
  'There is no NowField enabled in this type of code. We\'ll fix it - write us.' => 'В этом типе кода не подключен nowField.',
  ...
  'The array element does not fit the filtering conditions - the value is not a list.' => 'Элемент массива не соответствует условиям фильтрации — значение не является list.',
  ...
  '[[%s]] is not a multiple parameter.' => '[[%s]] — не является множественным параметром.',
  ...
  'Table [[%s]] was changed. Update the table to make the changes.' => 'Таблица [[%s]] была изменена. Обновите таблицу для произведения изменений.',
  ...
  'The format of the schema name is incorrect. Small English letters, numbers and - _' => 'Формат имени схемы неверен. Строчные латинские буквы, цифры и - _',
  ...
  'File > ' => 'Файл больше ',
  'File not received. May be too big.' => 'Файл не получен. Возможно размер слишком большой.',
  ...
  'Nothing' => 'Ничего',
  ' elem.' => ' элем.',
  'Operation [[%s]] over lists is not supported.' => 'Операция [[%s]] над list не предусмотрена.',
  'Operation [[%s]] over not mupliple select is not supported.' => 'Операция [[%s]] над not-multi Селектом не предусмотрена.',
  ...
  'Service is optimized for desktop browsers Chrome, Safari, Yandex latest versions. It seems that your version of the browser is not supported. Error - for developers: ' => 'Сервис оптимизирован под браузеры Chrome, Mozilla, Safary последних версий. Похоже, ваша версия браузера не поддерживается. Информация по ошибке:',
  ...
  'Due to exceeding the number of password attempts, your IP is blocked' => 'В связи с превышением количества попыток на ввод пароля ваш IP заблокирован на некоторое время.',
  ...
  'Forms user authorization error' => 'Ошибка авторизации пользователя с доступом к Формам',
  ...
  'Remote {var} does not exist or is not available to you' => 'Remote {var} не существует или не доступен для вашей роли',
  ...
  'You are not allowed to add to this table' => 'Добавление в эту таблицу недоступно для вашей роли',
  'You are not allowed to delete from this table' => 'Удаление из этой таблицы недоступно для вашей роли',
  'You are not allowed to sort in this table' => 'Сортировка в этой таблице недоступна для вашей роли',
  'You are not allowed to duplicate in this table' => 'Дублирование в этой таблице недоступно для вашей роли',
  'You are not allowed to restore in this table' => 'Восстановление в этой таблице недоступно для вашей роли',
  ...
  'Field not of type select/tree' => 'Поле не является полем с типом Селект/Дерево',
  'Field not of type comments' => 'Поле не является полем с типом Комментарии',
  ...
  'Add row out of date' => 'Строка добавления устарела',
  ...
  '[0: do not modify calculated fields] [1: change values of calculated fields already set to manual] [2: change calculated fields]' => '[0: рассчитываемые поля не обрабатываем] [1: меняем значения тех рассчитываемых полей которые уже имеют ручное значение] [2: меняем рассчитываемые поля]',
  'More than 20 nesting levels of table changes. Most likely a recalculation loop' => 'Больше 20 уровней вложенности изменения таблиц. Скорее всего — это зацикливание пересчета.',
  ...
  'script' => 'скрипт',
  'Field [[%s]] in table [[%s]] is not a column' => 'Полe [[%s]] в таблице [[%s]] не является колонкой таблицы',
  'In the %s parameter you must use a list by the number of rows to be changed or not a list.' => 'В параметре where необходимо использовать list, совпадающий по количеству изменяемых строк либо другой тип значения.',
  ...
  'Select format error in field %s' => 'Ошибка формата Cелекта в поле %s',
  'Not correct row in files list' => 'Неправильный массив в списке в files',
  'The field type %s cannot be in the pre-filter' => 'Поле типа %s не может находиться в префильтре',
  ...
  'Check that the ttm__search field type in table %s is data' => 'Проверьте, что поле ttm__search  в таблице %s имеет тип Данные',
  ...
  'The file is not protected' => 'Файл не явдляется защищенным',
  ...
  'LDAP extension php not enabled' => 'Расширение LDAP для PHP не включено',
  ...
  'This is not web user. He cannot be authorized by a token' => 'Это не web-пользователь. Он не может быть авторизован по токену.',
