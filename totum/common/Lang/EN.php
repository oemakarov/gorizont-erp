...
class EN implements LangInterface
{
  ...
  'TOTUM-code format error [[%s]].' => 'Gorizont-ERP code format error [[%s]].',
  ...
  'TOTUM-code format error: missing operator in expression [[%s]].' => 'Gorizont-ERP code format error: missing operator in expression [[%s]].',
  'TOTUM-code format error: missing part of parameter.' => 'Gorizont-ERP code format error: missing part of parameter.',
  ...
  'You can\'t install totum in schema "public"' => 'Gorizont-ERP cannot be installed in the public schema',
