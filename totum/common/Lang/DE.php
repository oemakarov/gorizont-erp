...
class DE implements LangInterface
{
  ...
  'TOTUM-code format error [[%s]].' => 'Formatfehler des Gorizont-ERP-Codes [[%s]].',
  ...
  'TOTUM-code format error: missing operator in expression [[%s]].' => 'Gorizont-ERP-Code-Formatfehler: Operator im Ausdruck [[%s]] fehlt.',
  'TOTUM-code format error: missing part of parameter.' => 'Gorizont-ERP-Code-Formatfehler: Teil des Parameters fehlt.',
  ...
  'You can\'t install totum in schema "public"' => 'Gorizont-ERP kann nicht im öffentlichen Schema installiert werden',
